...
public class Conexion2
{
    ...
    private final int PUERTO2 = 1234;
    private final String HOST = "localhost"; //Host para la conexión
    protected String mensajeServidor; //Mensajes entrantes (recibidos) en el servidor
    public String mensajeServidor2; //Mensajes entrantes (recibidos) en el servidor
    ...
    public Conexion2(String tipo) throws IOException //Constructor
    {
